...
class ListTokenManagerTest {
    ...
    fun OrderTokenTest() {
        ...
        val token3 = Token(DataType.SEMICOLON, "c", Pair(1, 3), Pair(2, 3))
        val token4 = Token(DataType.SEMICOLON, "d", Pair(1, 1), Pair(1, 2))
        ...
        assertEquals(orderedList[2], token3)
        assertEquals(orderedList[3], token1)
        assertEquals(orderedList[4], token5)
